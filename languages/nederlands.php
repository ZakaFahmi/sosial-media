...
$LNG['sidebar_messages'] = 'Berichten';
...
$LNG['sub_facebook'] = 'YJe facebook profiel ID.';
...
$LNG['sub_born'] = 'Selecteer de datum waarop je geboren bent (dag, maand, jaar)';
...
$LNG['ttl_notificationm'] = 'Berichten Meldingen';
$LNG['sub_notificationm'] = 'Melding weergeven voor <strong>Berichten</strong>';

$LNG['ttl_notificationd'] = 'Chat Meldingen';
$LNG['sub_notificationd'] = 'Melding weergeven voor <strong>Chats</strong>';

$LNG['ttl_email_comment'] = 'E-mails op Reacties';
$LNG['sub_email_comment'] = 'E-mail mijn wanneer iemand een reactie geeft op mijn berichten.';

$LNG['ttl_email_like'] = 'Emails op Vind ik leuk';
$LNG['sub_email_like'] = 'E-mail mijn wanneer iemand het leuk vind.';
...
$LNG['admin_ttl_notificationm'] = 'Berichten Meldingen';
$LNG['admin_sub_notificationm'] = 'Melding weer geven voor <strong>Berichten</strong> (kan worden veranderd in de gebruikers instellingen)';
...
$LNG['new_like_notification'] = '<strong><a href="%s">%s</a></strong> Vind <strong><a href="%s">post</a> leuk</strong>';
$LNG['new_comment_notification'] = '<strong><a href="%s">%s</a></strong> heeft gereageerd op een <strong><a href="%s">bericht</a></strong>';
$LNG['new_message_notification'] = '<strong><a href="%s">%s</a></strong> postte een nieuwe <strong><a href="%s">bericht</a></strong>';
