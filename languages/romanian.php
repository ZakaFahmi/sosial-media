...
$LNG['login_to_lcs'] = 'Vă rugăm autentificați-vă pentru pentru a putea Aprecia, Comenta sau Împărtăși';
...
$LNG['label_video'] = 'Împartașiți un link al unui clip de pe YouTube sau Vimeo';
$LNG['label_music'] = 'Adăugați o melodie ascultată';
...
$LNG['sub_born'] = 'Selecteați data nașterii (Luna, Zi, An)';
...
$LNG['ttl_notificationm'] = 'Notificări Mesaje';
$LNG['sub_notificationm'] = 'Afișează alertă și notificare pentru <strong>Mesaje</strong>';
...
$LNG['ttl_email_comment'] = 'E-mail la Comentarii';
$LNG['sub_email_comment'] = 'Primește e-mail când cineva comentează la mesajul tau.';

$LNG['ttl_email_like'] = 'E-mail la Aprecieri';
$LNG['sub_email_like'] = 'Primește e-mail când cineva apreciază un mesaj de-al tau.';
...
$LNG['admin_ttl_notificationm'] = 'Notificări Mesaje';
$LNG['admin_sub_notificationm'] = 'Afișează alertă și notificare pentru <strong>Mesaje</strong> (utilizatorul poate schimba această opțiune)';
...
$LNG['admin_sub_email_comment'] = 'Permite trimiterea de e-mailuri când cineva comentează la un mesaj';

$LNG['admin_ttl_email_like'] = 'Email la Aprecieri';
$LNG['admin_sub_email_like'] = 'Permite trimiterea de e-mailuri când cineva comentează apreciază un mesaj';
...
$LNG['new_like_notification'] = '<strong><a href="%s">%s</a></strong> a apreciat un <strong><a href="%s">post</a></strong>';
$LNG['new_comment_notification'] = '<strong><a href="%s">%s</a></strong> a comentat un <strong><a href="%s">post</a></strong>';
$LNG['new_message_notification'] = '<strong><a href="%s">%s</a></strong> a publicat un <strong><a href="%s">mesaj</a></strong>';
