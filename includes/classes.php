...
class register {
	...
	public $message_notification;	// Store the Admin Message Notification Settings  (Predefined, changeable)
	public $chat_notification;		// Store the Admin Chat Notification Settings  (Predefined, changeable)
	public $email_like;				// The general e-mail like setting [if allowed, it will turn on emails on registration]
	public $email_comment;			// The general e-mail like setting [if allowed, it will turn on emails on registration]
